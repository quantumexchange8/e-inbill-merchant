...
import { ToastSuccessIcon, ToastErrorIcon, ToastInfoIcon, ToastWarningIcon } from "@/Components/Icon/Brand";
...
const getClassNames = (toast) => {
  const baseClass = "transform bg-gray-900 p-4 rounded-lg shadow-xl flex gap-3 w-[605px]";
  switch (toast.type) {
    case 'success':
